...
plt.tight_layout()
fig1.savefig('/Users/welshofer/clawd/jlw-newsletter/images/chart-ifv-program-values.png', dpi=150, facecolor=BG, bbox_inches='tight')
plt.close(fig1)
...
plt.tight_layout()
fig2.savefig('/Users/welshofer/clawd/jlw-newsletter/images/chart-drone-kill-ratios.png', dpi=150, facecolor=BG, bbox_inches='tight')
plt.close(fig2)
...
bars1 = ax3.bar(x - width/2, pre_2022, width, label='Pre-2022 Annual Output', color=TEXT_SEC, alpha=0.5, edgecolor='white')
...
plt.tight_layout()
fig3.savefig('/Users/welshofer/clawd/jlw-newsletter/images/chart-production-surge.png', dpi=150, facecolor=BG, bbox_inches='tight')
plt.close(fig3)
