...
def main():
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-w-mortality-curve.png'),
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-philly-vs-stlouis.png'),
                dpi=150, facecolor=BG, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-global-death-toll.png'),
                dpi=150, facecolor=BG, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-three-waves.png'),
                dpi=150, facecolor=BG, bbox_inches='tight')
    plt.close()
