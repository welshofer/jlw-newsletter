...
def main():
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-recession-probabilities.png'),
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-debt-gdp.png'),
                dpi=150, facecolor=BG, bbox_inches='tight', pad_inches=0.3)
    plt.close()
    ...
    ax3.bar(x - width/2, values_2008, width, label='Pre-2008 Crisis', color=ACCENT, alpha=0.8)
    ax3.bar(x + width/2, values_2026, width, label='January 2026', color=WARNING, alpha=0.8)
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-policy-tools.png'),
                dpi=150, facecolor=BG, bbox_inches='tight', pad_inches=0.3)
    plt.close()
