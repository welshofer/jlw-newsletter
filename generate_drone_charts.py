...
plt.tight_layout()
fig1.savefig('/Users/welshofer/clawd/jlw-newsletter/images/chart-cost-asymmetry.png',
...
plt.tight_layout()
fig2.savefig('/Users/welshofer/clawd/jlw-newsletter/images/chart-manufacturing-speed.png',
             dpi=150, facecolor=BG, bbox_inches='tight')
plt.close(fig2)
...
plt.tight_layout()
fig3.savefig('/Users/welshofer/clawd/jlw-newsletter/images/chart-counter-drone-costs.png',
             dpi=150, facecolor=BG, bbox_inches='tight')
plt.close(fig3)
