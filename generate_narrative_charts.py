...
def main():
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-framework-timeline.png'),
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-framework-matrix.png'),
                dpi=150, facecolor=BG, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-complexity-memorability.png'),
                dpi=150, facecolor=BG, bbox_inches='tight')
    plt.close()
