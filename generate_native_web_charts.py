...
def main():
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-dev-costs.png'),
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-ai-productivity.png'),
                dpi=150, facecolor=BG, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-time-to-market.png'),
                dpi=150, facecolor=BG, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(output_path('images/chart-pwa-capabilities.png'),
                dpi=150, facecolor=BG, bbox_inches='tight')
    plt.close()
