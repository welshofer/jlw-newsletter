...
line1 = ax.bar(months, advance_km2, color=UKRAINE_BLUE, alpha=0.7, label='Territory Gained (km²)', width=0.6, edgecolor='white', linewidth=0.5)
line2 = ax2.plot(months, casualties_k, color=RUSSIA_RED, linewidth=2.5, marker='o', markersize=7,
